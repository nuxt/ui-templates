  ...
  <div class="relative p-10 n-bg-base">
    <div class="container w-full mx-auto flex flex-col gap-4">
      ...
      <div class="flex justify-between items-center">
        <div class="text-4xl">Nuxt UI</div>
      </div>
      ...
      <NCard class="p4">
        <div class="n-header-upper">Buttons</div>
        <div class="flex flex-wrap gap-3 items-center">
          <NButton n="yellow6 dark:yellow5 xs"> XS Yellow </NButton>
      ...
      <NCard class="p4">
        <div class="n-header-upper">Checkboxes</div>
      ...
      <NCard class="p4" n="green">
        <div class="n-header-upper">Links</div>
        <form class="flex gap-3 items-center">
          <NLink to="/"> NuxtLink </NLink>
          <NLink href="https://v3.nuxtjs.org/"> Nuxtjs.org </NLink>
        </form>
      </NCard>
      ...
      <NCard class="p4">
        <div class="n-header-upper">Switches</div>
        <div class="flex gap-3 items-center">
          <NSwitch n="lime6 dark:lime5 sm" :model-value="true"> SM </NSwitch>
          <NSwitch n="red6 dark:red5" :model-value="false"> Normal </NSwitch>
          <NSwitch :model-value="true" disabled> Disabled </NSwitch>
      ...
      <NCard class="p4">
        <div class="n-header-upper">Tips</div>
      ...
      <NCard class="p4">
        <div class="n-header-upper">Dropdown</div>
        <div class="flex flex-col gap-2">
      ...
      <NCard class="p4">
        <div class="n-header-upper">TextInput</div>
        <div class="flex flex-col gap-2">
          <NTextInput
            n="lime6 dark:lime5"
      ...
      <NCard class="p4">
        <div class="n-header-upper">Dialog</div>
        <div class="flex flex-col gap-2">
          ...
          >
            ...
            <div>
              <NButton @click="showDialog = false"> Close </NButton>
            </div>
          </NDialog>
        </div>
      </NCard>
